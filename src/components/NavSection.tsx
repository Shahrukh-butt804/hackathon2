  ...
  return (
    ...
    {/*  Top Nav */}
      <div className="flex justify-center md:justify-between bg-[#272343] text-white items-center  md:px-[300px] py-[14px]">
        ...
        <div className="flex items-center gap-5">
          <span className="flex cursor-pointer items-center gap-2">Eng <ArrowDown className="text-sm" size={16}/></span>
          <span className="cursor-pointer" onClick={() => router.push("/faqs")}>Faqs</span>
          <span className="flex items-center cursor-pointer gap-2"><OctagonAlert size={16}/> Need Help</span>
        </div>
    ...
    <div className="flex justify-between bg-[#f0f2f3]  items-center px-5 md:px-[300px] py-[20px]">
       ...
       <div className="flex items-center gap-4 rounded-lg p-2 bg-white">
        <ShoppingCart />
        <span>Cart</span>
        <span className="w-8 h-8 flex justify-center items-center bg-[#007580] text-white rounded-full">2</span>
