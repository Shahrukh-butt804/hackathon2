  ...
  return (
    <>
      ...
      <div className="px-[300px]">
        <p className=" font-semibold text-[28px] text-center mt-10">
        ...
        <div className="flex items-center flex-wrap gap-7 text-[#16808b] mt-6 mb-24">
          ...
          <section className="">
            <h1 className="px-[300px] text-2xl font-bold">Our Popular Products </h1>
        <div className=" mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-[180px]">

          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-start md:gap-2"
          >
            <div className="w-full flex flex-col gap-3 h-[454px] ">
